...
<body class="body" background=images/bg1.jpeg>
...
<?php 
  ...
  <div class="cd">
    <div class="main">
      ...
      <div><h1 class="overview">Cars we have for now</h1>
    ...
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking.php?id=<?php echo $res;?>">rent me now</a></button>
        </div>
    </div></form></li>
    <?php
        }
