...
<button class="back"><a href="index.php">To Homepage</a></button>
    ...
    <form class="form" method="POST">
        <h2>Admin Login</h2>
        <input class="h" type="text" name="adid" placeholder="Enter your admin id">
        <input class="h" type="password" name="adpass" placeholder="Enter your password">
